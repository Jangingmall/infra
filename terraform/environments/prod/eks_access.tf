# ============================================================
# eks_access.tf — EKS 클러스터 접근 권한 (prod)
# ------------------------------------------------------------
# Backend-Dev는 조회만, Infra-Admin은 읽기+쓰기,
# Security-Audit은 감사 목적 조회.
# ============================================================
...
resource "aws_eks_access_policy_association" "backend_dev_view" {
  cluster_name  = module.eks.cluster_name
